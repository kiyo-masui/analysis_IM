pro mk_hicube_noise_fg,Tsky,flagtot,noisecal,ra,dec,freq,pol,parallatic,radio=radio,weight=weight,fin=fin,field=field,kstart=kstart,kend=kend,f0=f0,flagnum=flagnum,Npol=Npol,noiseradio=noiseradio
