pro docalib_svdfill_sim,radio,weight,t_off,radio_on,weight_on,field=field,fn=fn,sigmacut=sigmacut,dname=dname,svdfg=svdfg,fitsfile=fitsfile,sim=sim,signal=signal,dosigcut=dosigcut
...
for ifile=0,nfile-1 do begin
   ...
   frdir='/cita/d/raid-cita/tchang/GBT/Processed/'+dname+'/'+field+'_'+ffdir(ifile)+'/'
   fdir='/cita/d/raid-cita/tchang/GBT/Processed_mode/'+dname+'/'+field+'_'+ffdir(ifile)+'/'
...
;      endfor
      ;
      fdir='/cita/d/raid-cita/tchang/GBT/Processed_mode_simonly_'+signal+'/'+dname+'/'+field+'_'+ffdir(ifile)+'/'
      spawn,'mkdir '+fdir
      ;
   endif
   ;
