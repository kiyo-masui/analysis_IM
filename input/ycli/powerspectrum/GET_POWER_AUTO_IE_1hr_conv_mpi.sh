...
MODE="40"
HOUR="1"
mpirun -np 1 -pernode python $PIPELINE_DIR/mpimanager.py $PIPELINE_DIR_P/power_noise_auto.pipe
mpirun -np 1 -pernode python $PIPELINE_DIR/mpimanager.py $PIPELINE_DIR_P/reference_auto.pipe
mpirun -np 1 -pernode python $PIPELINE_DIR/mpimanager.py $PIPELINE_DIR_P/reference_auto_degradebeam.pipe
mpirun -np 1 -pernode python $PIPELINE_DIR/mpimanager.py $PIPELINE_DIR_P/transfer_auto.pipe
mpirun -np 1 -pernode python $PIPELINE_DIR/mpimanager.py $PIPELINE_DIR_P/power_auto.pipe
