...
#mpirun -np 20 -npernode 20 python $PIPELINE_DIR/mpimanager.py $PIPELINE_DIR_P/transfer_cros.pipe
#mpirun -np 20 -npernode 20 python $PIPELINE_DIR/mpimanager.py $PIPELINE_DIR_P/power_cros.pipe
