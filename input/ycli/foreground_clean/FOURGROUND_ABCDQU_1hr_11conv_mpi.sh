...
#export pipeline=foreground_clean/cleaned_AQU_1hr_extend_11conv_mpi.pipe
#python $PIPELINE_DIR/manager.py $PIPELINE_DIR/$pipeline
#export pipeline=foreground_clean/cleaned_BQU_1hr_extend_11conv_mpi.pipe
#python $PIPELINE_DIR/manager.py $PIPELINE_DIR/$pipeline
#export pipeline=foreground_clean/cleaned_CQU_1hr_extend_11conv_mpi.pipe
#python $PIPELINE_DIR/manager.py $PIPELINE_DIR/$pipeline
#export pipeline=foreground_clean/cleaned_DQU_1hr_extend_11conv_mpi.pipe
#python $PIPELINE_DIR/manager.py $PIPELINE_DIR/$pipeline
#
export SIMFILE=1
...
export pipeline=foreground_clean/combine_ABCD_11conv.pipe
#python $PIPELINE_DIR/manager.py $PIPELINE_DIR/$pipeline
mpirun $EXP -np 60 -npernode 20 -hostfile $PIPELINE_DIR/HOSTFILE python $PIPELINE_DIR/mpimanager.py $PIPELINE_DIR/$pipeline
