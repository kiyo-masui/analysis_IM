...
from foreground_clean import find_modes as fm
...
class MapPair(object):
    ...
    def __init__(self, map1, map2, noise_inv1, noise_inv2, freq1, freq2=None,
        ...
        self.map1_code = ''
        self.map2_code = ''
        print 'Setting self.params for map_pair'
        self.params = params_init
        print self.params['degrade_factor']
    ...
    def set_names(self, name1, name2):
        ...
        sections = ["beam1", "beam2", "beam3", "beam4", "beam5", "beam6",
 "beam7", "beam8", "beam9", "beam10", "beam11", "beam12", "beam13"]
    ...
    def make_noise_factorizable(self, weight_prior=4.e-4):
    ...
    def freq_covariance(self):
        return fm.freq_covariance(self.map1, self.map2,
                                               self.noise_inv1,
                                               self.noise_inv2,
