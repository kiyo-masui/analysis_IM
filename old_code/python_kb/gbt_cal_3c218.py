...
## get T_sys use T_3c218 * (off/(on-off)) all with cal off
mask_on = (mask_polx*mask_cal_off*mask_scan_on)
mask_off = (mask_polx*mask_cal_off*mask_scan_off)
mask_noise_on = (mask_polx*mask_cal_on*mask_scan_off)
mask_noise_off = (mask_polx*mask_cal_off*mask_scan_off)
...
pylab.title("x Noise Diode Temperature")
pylab.xlabel("freq(Hz)")
pylab.ylabel("Temperature (K)")
pylab.savefig("x_noise_diode_temp_3c218.png", dpi=300)
pylab.show() 
...
pylab.title("x System Temperature")
pylab.xlabel("freq(Hz)")
pylab.ylabel("Temperature (K)")
pylab.savefig("x_system_temp_3c218.png", dpi=300)
