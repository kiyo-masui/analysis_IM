...
cal_filename = '/home/scratch/kbandura/GBT09C_075/00_3c218_onoff_scan5-8.raw.acs.fits'

T_noise,T_sys =  gbt_cal.getcal_3c218(cal_filename)
...
filename = '/home/scratch/kbandura/GBT09C_075/00_zCOSMOS_drift_9-17.raw.acs.fits'
...
for scan in unique_scan_n:
 ...
 #pylab.ylim(-2,2)
   ...
   pylab.savefig("zcosmos_T_intensity_"+window_names[i]+"_"+str(cut)+"K_cut_tnoisecal_"+str(scan)+".png", dpi=300)
   pylab.clf()
   #pylab.close()
   ...
   pylab.xlabel('ra')
   pylab.ylabel('temperature')
   pylab.savefig('zcosmos_T_I_total_power_'+window_names[i]+"_"+str(scan)+'.png', dpi=300)
   pylab.clf()
