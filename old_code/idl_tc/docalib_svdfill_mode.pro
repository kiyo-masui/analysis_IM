pro docalib_svdfill_mode,radio,weight,t_off,radio_on,weight_on,field=field,fn=fn,sigmacut=sigmacut,dname=dname,svdfg=svdfg,fitsfile=fitsfile,sim=sim,signal=signal
...
if not keyword_set(signal) then signal='10muK'
...
for ifile=0,nfile-1 do begin
   ...
   frdir='/mnt/raid-cita/tchang/GBT/Processed/'+dname+'/'+field+'_'+ffdir(ifile)+'/'
   fdir='/mnt/raid-cita/tchang/GBT/Processed/'+dname+'/'+field+'_'+ffdir(ifile)+'/'
;   fsdir='/cita/scratch/cottontail/tchang/GBT/Processed/'+dname+'/svd_nominus1/'+field+'_'+ffdir(ifile)+'/'
   ...
   if keyword_set(fitsfile) then begin
      ...
      ;
      device,filename=fdir+'Psky_freq_matched.mode2.ps'
      ...
      ;
      ;
      device,filename=fdir+'Pnoise_freq_matched.mode2.ps'
      ...
      openr,1,frdir+'radio_tf_b4svd'
      readf,1,time_freq_flag
      close,1
      ; 
      openr,1,frdir+'flagtot_tf_b4svd'
      readf,1,flagtot
      close,1
      ;
      openr,1,frdir+'noisecal_tf_b4svd'
      readf,1,time_freq_noise
      close,1
      ;
      openr,1,frdir+'freqtot'
      readf,1,freqtot
      close,1
      ;
      openr,1,frdir+'ra'
...
;      for scan=0,nscan-1 do begin
      ...
      openr,1,frdir+'simradio_tf_b4svd_'+signal
      readf,1,radiotfsim
      close,1
      help,time_freq_flag
...
;      endfor
      ;
      fdir='/mnt/raid-cita/tchang/GBT/Processed_sim_'+signal+'/'+dname+'/'+field+'_'+ffdir(ifile)+'/'
      spawn,'mkdir '+fdir
      ;
   endif
   ;
 ...
 ;     freqnum=freqnum>1
      ...
      ;
      device,filename=fdir+'Psky_svd1.mode2.ps'
      ...
      ;
      ;
      device,filename=fdir+'Psky_svd1.scut.mode2.ps'
      ;
      tfradio=dblarr(ntime*nscan,nz)
      ...
      ;
      ;
      openw,2,fdir+field+'.timevec_7mode'
      openw,3,fdir+field+'.timevec_8mode'
      openw,4,fdir+field+'.timevec_9mode'
      openw,5,fdir+field+'.timevec_11mode'
      openw,6,fdir+field+'.timevec_12mode'
      openw,12,fdir+field+'.freqvec_7mode'
      openw,13,fdir+field+'.freqvec_8mode'
      openw,14,fdir+field+'.freqvec_9mode'
      openw,15,fdir+field+'.freqvec_11mode'
      openw,16,fdir+field+'.freqvec_12mode'
      openw,22,fdir+field+'.eigenvalue_7mode'
      openw,23,fdir+field+'.eigenvalue_8mode'
      openw,24,fdir+field+'.eigenvalue_9mode'
      openw,25,fdir+field+'.eigenvalue_11mode'
      openw,26,fdir+field+'.eigenvalue_12mode'
      for ii=0,npol-1 do begin
         ;
         radio2d=reform(time_freq_flag(*,ii,*))
         la_svd,radio2d, s,u,v,/double,status=status
      ...
      ;
      ;
      device,filename=fdir+'Psky_svd2.mode2.ps'
      ;
      tfradio=dblarr(ntime*nscan,nz)
      thermal=(dnu*dt)*(flagtot0mode)
      for ifreq=0,nz-1 do begin
      ...
      plt_image, transpose(tfradio),/scalable,/colbar
      openw,1,fdir+field+'.Psky_svd2_7mode.dat'
      printf,1,tfradio
      close,1
      ...
      plt_image, transpose(tfradio),/scalable,/colbar
      openw,1,fdir+field+'.Psky_svd2_8mode.dat'
      printf,1,tfradio
      close,1
      ;
      ;
      ...
      plt_image, transpose(tfradio),/scalable,/colbar
      openw,1,fdir+field+'.Psky_svd2_9mode.dat'
      printf,1,tfradio
      close,1
      ...
      plt_image, transpose(tfradio),/scalable,/colbar
      openw,1,fdir+field+'.Psky_svd2_11mode.dat'
      printf,1,tfradio
      close,1
      ...
      plt_image, transpose(tfradio),/scalable,/colbar
      openw,1,fdir+field+'.Psky_svd2_12mode.dat'
      printf,1,tfradio
      close,1
      ;
      device,/close
      ;
      ;
      device,filename=fdir+field+'.Pnoise_flag.mode2.ps'
      plt_image,transpose(reform(time_freq_noise(*,0,*))),/scalable,/colbar
      plt_image,transpose(reform(time_freq_noise(*,1,*))),/scalable,/colbar
      plt_image,transpose(reform(time_freq_noise(*,2,*))),/scalable,/colbar
      plt_image,transpose(reform(time_freq_noise(*,3,*))),/scalable,/colbar
   ...
   endelse
;
   device,filename=fdir+'Psky_xz_aftsvd.mode2.ps'
   ;
   ;
   radio2=radio0mode
   ...
   ;
   ;
   openw,1,fdir+field+'.radio9mode_aftsvd'
   printf,1,radio
   close,1
   ;
   openw,1,fdir+field+'.weight9mode_aftsvd'
   printf,1,weight
   close,1
   ;
   openw,1,fdir+field+'.radio11mode_aftsvd'
   printf,1,radio20mode
   close,1
   ;
   openw,1,fdir+field+'.weight11mode_aftsvd'
   printf,1,weight20mode
   close,1
   ;
   openw,1,fdir+field+'.radio12mode_aftsvd'
   printf,1,radio25mode
   close,1
   ;
   openw,1,fdir+field+'.weight12mode_aftsvd'
   printf,1,weight25mode
   close,1
   ;
   openw,1,fdir+field+'.radio8mode_aftsvd'
   printf,1,radio10mode
   close,1
   ;
   openw,1,fdir+field+'.weight8mode_aftsvd'
   printf,1,weight10mode
   close,1
   ;
   openw,1,fdir+field+'.radio7mode_aftsvd'
   printf,1,radio5mode
   close,1
   ;
   openw,1,fdir+field+'.weight7mode_aftsvd'
   ...
   radio2(ind)=radio2(ind)/weight(ind)
   ;
   openw,1,fdir+field+'.radio9mode_weighted_aftsvd'
   printf,1,radio2
   close,1
   ;
   radio2=radio20mode
   ...
   radio2(ind)=radio2(ind)/weight20mode(ind)
   ;
   openw,1,fdir+field+'.radio11mode_weighted_aftsvd'
   printf,1,radio2
   close,1
   ;
   radio2=radio25mode
   ...
   radio2(ind)=radio2(ind)/weight25mode(ind)
   ;
   openw,1,fdir+field+'.radio12mode_weighted_aftsvd'
   printf,1,radio2
   close,1
   ;
   radio2=radio10mode
   ...
   radio2(ind)=radio2(ind)/weight10mode(ind)
   ;
   openw,1,fdir+field+'.radio8mode_weighted_aftsvd'
   printf,1,radio2
   close,1
   ;
   radio2=radio5mode
   ...
   radio2(ind)=radio2(ind)/weight5mode(ind)
   ;
   openw,1,fdir+field+'.radio7mode_weighted_aftsvd'
   printf,1,radio2
   close,1
   ;
   radio2=radio0mode
...
openw,1,fdir+field+'.radiotot9mode_aftsvd'
printf,1,radiotot
close,1
;
openw,1,fdir+field+'.weighttot9mode_aftsvd'
printf,1,weighttot
close,1
;
...
;
openw,1,fdir+field+'.radiotot9mode_weighted_aftsvd'
printf,1,radiotot
close,1
;
;

openw,1,fdir+field+'.radiotot11mode_aftsvd'
printf,1,radiotot20mode
close,1
;
openw,1,fdir+field+'.weighttot11mode_aftsvd'
...
;
openw,1,fdir+field+'.radiotot11mode_weighted_aftsvd'
printf,1,radiotot20mode
close,1
;
openw,1,fdir+field+'.radiotot12mode_aftsvd'
printf,1,radiotot25mode
close,1
;
openw,1,fdir+field+'.weighttot12mode_aftsvd'
...
;
openw,1,fdir+field+'.radiotot12mode_weighted_aftsvd'
printf,1,radiotot25mode
close,1
;
;
openw,1,fdir+field+'.radiotot8mode_aftsvd'
printf,1,radiotot10mode
close,1
;
openw,1,fdir+field+'.weighttot8mode_aftsvd'
...
;
openw,1,fdir+field+'.radiotot8mode_weighted_aftsvd'
printf,1,radiotot10mode
close,1
;
;
openw,1,fdir+field+'.radiotot7mode_aftsvd'
printf,1,radiotot5mode
close,1
;
openw,1,fdir+field+'.weighttot7mode_aftsvd'
...
;
openw,1,fdir+field+'.radiotot7mode_weighted_aftsvd'
printf,1,radiotot5mode
close,1
;
;
...
;
;
device,filename=fdir+'Pskytot_aftsvd.mode2.ps'
;
