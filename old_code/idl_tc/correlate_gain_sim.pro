PRO correlate_gain_sim,corrv1,corrv2,corre1,corre2,corrm1,corrm2,radio,weight,optical,field=field,fin=fin,radiocut=radiocut,fdir=fdir,noise=noise,sim=sim,daisy=daisy,outfile=outfile,dname=dname,svdfg=svdfg,mode=mode,combine=combine,dosigcut=dosigcut,mask=mask,sigcut5=sigcut5
...
;   thisdir='/cita/d/raid-cita/tchang/GBT/Processed/'
   sdir='/mnt/raid-cita/tchang/GBT/Processed_sim_'+signal+sigcut5+'/'
   thisdir='/mnt/raid-cita/tchang/GBT/Processed'+sigcut5+'/'
