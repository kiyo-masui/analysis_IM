PRO correlate_gain_test,corrv1,corrv2,corre1,corre2,corre3,corrm1,corrm2,radio,weight,optical,field=field,fin=fin,radiocut=radiocut,fdir=fdir,noise=noise,sim=sim,daisy=daisy,outfile=outfile,dname=dname,svdfg=svdfg,mode=mode,combine=combine
...
for iday=0,nday-1 do begin
   ...
   gainztot(iday,*,*)=gainz
   ;
;   if keyword_set(blackout) then begin
