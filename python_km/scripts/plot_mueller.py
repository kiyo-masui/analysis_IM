...
pylab.axis('auto')
pylab.axis([650,950,-1,1])
pylab.legend(('deltaG', 'epsilon'))
pylab.xlabel('frequency')
pylab.savefig('mueller_params_deltaG_epsilon_25-27.png')
pylab.clf()
...
pylab.savefig('mueller_params_alpha_25-27.png')
pylab.clf()
...
pylab.savefig('mueller_params_psi_25-27.png')
pylab.clf()
...
pylab.savefig('mueller_params_phi_25-27.png')
pylab.clf()
...
pylab.savefig('mueller_params_Q_U_25-27.png')
pylab.clf()
...
pylab.savefig('mueller_params_ratio_25-27.png')
pylab.clf()
