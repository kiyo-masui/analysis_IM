...
def plot_gbt_mapset(outputdir="/cita/d/www/home/eswitzer/movies/",
    ...
    pc.plot_gbt_maps('GBT_1hr_map_oldcalpolstack', outputdir=outputdir,
                     make_map=make_map, make_dirty_map=make_dirty_map,
                     make_noise_inv=make_noise_inv,
                     make_noise_diag=make_noise_diag)

    pc.plot_gbt_maps('GBT_1hr_map_oldcalpolstack_Q', outputdir=outputdir,
                     make_map=make_map, make_dirty_map=make_dirty_map,
                     make_noise_inv=make_noise_inv,
                     make_noise_diag=make_noise_diag)

    pc.plot_gbt_maps('GBT_1hr_map_oldcalpolstack_U', outputdir=outputdir,
                     make_map=make_map, make_dirty_map=make_dirty_map,
                     make_noise_inv=make_noise_inv,
                     make_noise_diag=make_noise_diag)

    pc.plot_gbt_maps('GBT_1hr_map_oldcalpolstack_V', outputdir=outputdir,
                     make_map=make_map, make_dirty_map=make_dirty_map,
                     make_noise_inv=make_noise_inv,
                     make_noise_diag=make_noise_diag)
...
if __name__ == "__main__":
    ...
    plot_gbt_comb_modeset('GBT_1hr_map_oldcalpolstack_cleaned_combined', convolve=True)
    ...
    #plot_gbt_comb_modeset('GBT_1hr_map_autopaper_cleaned_combined', convolve=True,
    #                       outputdir="/mnt/raid-project/gmrt/eswitzer/GBT/movies/")
    ...
    #plot_gbt_mapset(outputdir="/mnt/raid-project/gmrt/eswitzer/GBT/movies/")
    #plot_gbt_mapset()
