/* Generated by Cython 0.12.1 on Wed Oct 17 01:37:16 2012 */
...
/* "/cita/h/home-2/mufma/code/analysis_IM/utils/_sphbessel_c.pyx":10
...
static PyObject *__pyx_pf_12_sphbessel_c__jl_gsl(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_12_sphbessel_c__jl_gsl(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_jl_gsl");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "_jl_gsl") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_l = values[0];
    __pyx_v_z = values[1];
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("_sphbessel_c._jl_gsl");
  return NULL;
  ...
  /* "/cita/h/home-2/mufma/code/analysis_IM/utils/_sphbessel_c.pyx":13
 *     cdef int e
 *     cdef double d[2]
 ...
 */
  ...
  /* "/cita/h/home-2/mufma/code/analysis_IM/utils/_sphbessel_c.pyx":14
 *     cdef double d[2]
 *     gsl_set_error_handler_off ()
 *     l,z = np.broadcast_arrays(l, z)             # <<<<<<<<<<<<<<
 *     r = np.zeros_like(l).astype(np.float64)
 ...
 */
  ...
  if (PyTuple_CheckExact(__pyx_t_3) && likely(PyTuple_GET_SIZE(__pyx_t_3) == 2)) {
    ...
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_1 = __Pyx_UnpackItem(__pyx_t_4, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_UnpackItem(__pyx_t_4, 1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    if (__Pyx_EndUnpack(__pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/cita/h/home-2/mufma/code/analysis_IM/utils/_sphbessel_c.pyx":15
 *     gsl_set_error_handler_off ()
 *     l,z = np.broadcast_arrays(l, z)
 *     r = np.zeros_like(l).astype(np.float64)             # <<<<<<<<<<<<<<
 *     for i in range(r.size):
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_v_l);
  __pyx_t_1 = PyObject_Call(__pyx_t_2, __pyx_t_3, NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "/cita/h/home-2/mufma/code/analysis_IM/utils/_sphbessel_c.pyx":16
 *     l,z = np.broadcast_arrays(l, z)
 *     r = np.zeros_like(l).astype(np.float64)
 *     for i in range(r.size):             # <<<<<<<<<<<<<<
 *         e = <int>gsl_sf_bessel_jl_e(<int>(l.flat[i]), <double>(z.flat[i]), d)
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_t_2);
  __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_Call(__pyx_builtin_range, __pyx_t_1, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyList_CheckExact(__pyx_t_2) || PyTuple_CheckExact(__pyx_t_2)) {
    __pyx_t_5 = 0; __pyx_t_1 = __pyx_t_2; __Pyx_INCREF(__pyx_t_1);
  } else {
    __pyx_t_5 = -1; __pyx_t_1 = PyObject_GetIter(__pyx_t_2); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
  }
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  for (;;) {
    ...
    /* "/cita/h/home-2/mufma/code/analysis_IM/utils/_sphbessel_c.pyx":17
 *     r = np.zeros_like(l).astype(np.float64)
 *     for i in range(r.size):
 *         e = <int>gsl_sf_bessel_jl_e(<int>(l.flat[i]), <double>(z.flat[i]), d)             # <<<<<<<<<<<<<<
 *         #if e != 0:
 ...
 */
    ...
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_v_e = ((int)gsl_sf_bessel_jl_e(((int)__pyx_t_6), ((double)__pyx_t_7), __pyx_v_d));

    /* "/cita/h/home-2/mufma/code/analysis_IM/utils/_sphbessel_c.pyx":21
 *         #    print l.flat[i], z.flat[i]
 ...
 */
  ...
  /* "/cita/h/home-2/mufma/code/analysis_IM/utils/_sphbessel_c.pyx":23
 *         r.flat[i] = d[0]
 * 
 *     return r             # <<<<<<<<<<<<<<
 */
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("_jl_gsl"), (PyCFunction)__pyx_pf_12_sphbessel_c__jl_gsl, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit__sphbessel_c(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_sphbessel_c"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/cita/h/home-2/mufma/code/analysis_IM/utils/_sphbessel_c.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 * cimport numpy as np
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init _sphbessel_c");
